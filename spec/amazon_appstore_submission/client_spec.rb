  ...
  context 'with client credentials' do
    ...
    describe 'edit functionality' do
      ...
      it 'creates an edit' do
        stub_request(:post, "#{base_url}/#{app_id}/edits")
      ...
      it 'gets an edit' do
        stub_request(:get, "#{base_url}/#{app_id}/edits/#{edit_id}")
          .to_return_json(status: 200, body: { id: edit_id, status: 'IN_PROGRESS' })
      ...
      it 'deletes an edit' do
        stub_request(:delete, "#{base_url}/#{app_id}/edits/#{edit_id}")
      ...
      it 'validates an edit' do
        stub_request(:post, "#{base_url}/#{app_id}/edits/#{edit_id}/validate")
      ...
      it 'commits changes to an edit' do
        stub_request(:post, "#{base_url}/#{app_id}/edits/#{edit_id}/commit")
          .with(headers: { 'If-Match' => 'etag-value' })
          .to_return_json(status: 200, body: { id: edit_id })
    ...
    describe 'edit listing functionality' do
      ...
      it 'fetches all listings' do
        stub_request(:get, "#{base_url}/#{app_id}/edits/#{edit_id}/listings")
          .to_return_json(status: 200, body: { listings: { 'en-GB' => json_data } })
      ...
      it 'gets a single listing' do
        stub_request(:get, "#{base_url}/#{app_id}/edits/#{edit_id}/listings/en-GB")
      ...
      it 'updates a listing' do
        stub_request(:put, "#{base_url}/#{app_id}/edits/#{edit_id}/listings/en-GB")
          .with(headers: { 'If-Match' => 'etag-value' })
          .to_return_json(status: 200, body: json_data)
      ...
      it 'deletes a listing' do
        stub_request(:delete, "#{base_url}/#{app_id}/edits/#{edit_id}/listings/en-GB")
          .with(headers: { 'If-Match' => 'etag-value' })
          .to_return(status: 204)
    ...
    describe 'edit detail functionality' do
      ...
      it 'gets details' do
        stub_request(:get, "#{base_url}/#{app_id}/edits/#{edit_id}/details")
          .to_return_json(status: 200, body: json_data)
      ...
      it 'updates details' do
        stub_request(:put, "#{base_url}/#{app_id}/edits/#{edit_id}/details")
          .with(headers: { 'If-Match' => 'etag-value' })
          .to_return_json(status: 200, body: json_data)
    ...
    describe 'edit APK functionality' do
      ...
      it 'gets apks' do
        stub_request(:get, "#{base_url}/#{app_id}/edits/#{edit_id}/apks")
          .to_return_json(status: 200, body: [json_data])
      ...
      it 'gets a single apk' do
        stub_request(:get, "#{base_url}/#{app_id}/edits/#{edit_id}/apks/#{apk_id}")
          .to_return_json(status: 200, body: json_data)
      ...
      it 'deletes an apk' do
        stub_request(:delete, "#{base_url}/#{app_id}/edits/#{edit_id}/apks/#{apk_id}")
          .with(headers: { 'If-Match' => 'etag-value' })
          .to_return(status: 204)
      ...
      it 'replaces an apk' do
        stub_request(:put, "#{base_url}/#{app_id}/edits/#{edit_id}/apks/#{apk_id}/replace")
          .with(headers: { 'If-Match' => 'etag-value' })
          .to_return_json(status: 200, body: json_data)
      ...
      it 'uploads a large apk' do
        stub_request(:post, "#{base_url}/#{app_id}/edits/#{edit_id}/apks/large/upload")
          .to_return_json(status: 200, body: { fileId: 'amzn1.devportal.fileupload.abc' })
      ...
      it 'attaches an uploaded apk' do
        ...
        stub_request(:post, "#{base_url}/#{app_id}/edits/#{edit_id}/apks/attach")
          .to_return_json(status: 200, body: json_data)
      ...
      it 'uploads and attaches an apk' do
        stub_request(:post, "#{base_url}/#{app_id}/edits/#{edit_id}/apks/upload")
          .to_return_json(status: 200, body: json_data)
    ...
    describe 'images functionality' do
      let(:filepath) { File.expand_path(File.join(__dir__, '..', 'fixtures', 'mock-image.png')) }
      let(:language) { 'en-US' }
      let(:json_data) do
        {
          'images' => [
      ...
      it 'gets all images' do
        stub_request(:get, "#{base_url}/#{app_id}/edits/#{edit_id}/listings/#{language}/screenshots")
          .to_return_json(status: 200, body: json_data)
      ...
      it 'uploads an image' do
        stub_request(:post, "#{base_url}/#{app_id}/edits/#{edit_id}/listings/#{language}/screenshots/upload")
          .with(headers: { 'If-Match' => 'etag-value' })
          .to_return_json(status: 200, body: { image: { id: 'amzn1.dex.asset.abc123' } })

        @instance.etag_cache[[edit_id, language].join('-')] = 'etag-value'
        result = @instance.upload_image(filepath,
      ...
      it 'deletes an image' do
        ...
        stub_request(:delete, "#{base_url}/#{app_id}/edits/#{edit_id}/listings/#{language}/screenshots/#{asset_id}")
          .with(headers: { 'If-Match' => 'etag-value' })
          .to_return(status: 204)

        @instance.etag_cache[[edit_id, language].join('-')] = 'etag-value'
        result = @instance.delete_image(asset_id,
                                        image_type: 'screenshots',
                                        language: language,
                                        edit_id: edit_id,
                                        app_id: app_id)
      ...
      it 'deletes all images' do
        stub_request(:delete, "#{base_url}/#{app_id}/edits/#{edit_id}/listings/#{language}/screenshots")
          .with(headers: { 'If-Match' => 'etag-value' })
          .to_return(status: 204)
    ...
    describe 'videos functionality' do
      let(:filepath) { File.expand_path(File.join(__dir__, '..', 'fixtures', 'mock-video.mp4')) }
      let(:language) { 'en-US' }
      let(:json_data) do
        {
          'videos' => [
      ...
      it 'gets all videos' do
        stub_request(:get, "#{base_url}/#{app_id}/edits/#{edit_id}/listings/#{language}/videos")
          .to_return_json(status: 200, body: json_data)
      ...
      it 'uploads a video' do
        stub_request(:post, "#{base_url}/#{app_id}/edits/#{edit_id}/listings/#{language}/videos/upload")
          .with(headers: { 'If-Match' => 'etag-value' })
          .to_return_json(status: 200, body: { video: { id: 'amz1.dex.asset.video1' } })
      ...
      it 'deletes a video' do
        ...
        stub_request(:delete, "#{base_url}/#{app_id}/edits/#{edit_id}/listings/#{language}/videos/#{asset_id}")
          .with(headers: { 'If-Match' => 'etag-value' })
          .to_return(status: 204)
      ...
      it 'deletes all videos' do
        stub_request(:delete, "#{base_url}/#{app_id}/edits/#{edit_id}/listings/#{language}/videos")
          .with(headers: { 'If-Match' => 'etag-value' })
          .to_return(status: 204)
    ...
    describe 'availability functionality' do
      ...
      it 'gets availability' do
        stub_request(:get, "#{base_url}/#{app_id}/edits/#{edit_id}/availability")
          .to_return_json(status: 200, body: json_data)
      ...
      it 'updates availability' do
        stub_request(:put, "#{base_url}/#{app_id}/edits/#{edit_id}/availability")
          .with(headers: { 'If-Match' => 'etag-value' })
          .to_return_json(status: 200, body: json_data)
    ...
    describe 'targeting functionality' do
      ...
      it 'gets targeting' do
        stub_request(:get, "#{base_url}/#{app_id}/edits/#{edit_id}/apks/#{apk_id}/targeting")
          .to_return_json(status: 200, body: json_data)
      ...
      it 'updates targeting' do
        stub_request(:put, "#{base_url}/#{app_id}/edits/#{edit_id}/apks/#{apk_id}/targeting")
          .with(headers: { 'If-Match' => 'etag-value' })
          .to_return_json(status: 200, body: json_data)
